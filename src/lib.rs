...
pub fn handle_subcommands(matches: &clap::ArgMatches, config: & mut Config) -> Result<(),Error> {
...
pub fn fetch_script<'a>(alias: &str, config: &'a Config) -> Option<&'a Script> {
...
pub fn run_command(alias: &str, command: &str, arg: &str) {
